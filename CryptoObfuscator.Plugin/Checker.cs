...
namespace CryptoObfuscator.Plugin
{
    public class Checker : IPlugin
    {
        ...
        {
            string resp = http.DownloadString("http://www.ssware.com/cryptoobfuscator/download.htm");
            string version = string.Format("2015 Build {0}", resp.Substring("<!--START_BUILDNUM-->", "<!--END_BUILDNUM-->"));
